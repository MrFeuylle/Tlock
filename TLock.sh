echo "echo Tu as oublie de lock" >> ~/.zshrc
clear
zenity --title "Tu as oublie de lock ta session" --height=200 --width=800 --warning --text="<span color=\"red\"><span size=\"80000\">Oups, un API a vu que tu n'as pas lock</span></span>"
